...
__all__ = ["SFUncertMetric", "SFUncertMetricDev"]

class SFUncertMetricDev(BaseMetric):
    ...
    def __init__(
        ...
        metricName="Structure Function Uncert Dev",
        snr_cut=5,
        filterCol="filter",
        dust=True,
        **kwargs
        ...
        maps = ["DustMap"]
        super(SFUncertMetricDev, self).__init__(
